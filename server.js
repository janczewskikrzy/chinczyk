...
app.post('/login', (req, res) => {
    ...
    let player = new Player(req.body.nick, uuidv4(), room.Color())
...
app.get('/rollTheDice', (req, res) => {
    ...
    let room = finder.findRoomById(rooms, id),
        ...
        pawnMoves = logic.retrievePawnsThatCanMove(player, rolls)

    if (logic.checkIfMovesAreEmpty(pawnMoves)) {
        player.roll.expires = player.roll.time + (180)
        setTimeout(() => {
